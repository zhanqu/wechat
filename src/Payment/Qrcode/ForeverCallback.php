...
namespace Zhanqu\Wechat\Payment\Qrcode;

use Zhanqu\Wechat\Bridge\Util;
use Zhanqu\Wechat\Bridge\Serializer;
use Zhanqu\Wechat\Bridge\XmlResponse;
use Zhanqu\Wechat\Payment\Unifiedorder;
